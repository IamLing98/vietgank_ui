    ...
    <div className="main-wrapper">
      ...
      <div className="flex mt-[4.7rem] md:mt-0">
        ...
        <nav className="side-nav">
          <Link to="/side-menu/dashboard-overview-1" className="intro-x flex items-center pl-5 pt-4">
            <img alt="Midone Tailwind HTML Admin Template" className="w-6" src={logoUrl} />
            <span className="hidden xl:block text-white text-lg ml-3">Vietgangz</span>
          </Link>
