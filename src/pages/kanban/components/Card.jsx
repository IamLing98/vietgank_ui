...
const KanBanCard = (props) => {
    ...
    return (
        <StyledCard data-tut="reactour__card">
                                        ...
                                        {(dragProvided) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <IconButton
                                                        data-tut="reactour__more"
                                                        onClick={(e) => showActionMenu(e.currentTarget, task.id)}
                                                    >
                                                        <MoreOutlined />
                                                    </IconButton>
                                                </div>
                            ...
                            <Grid container>
                                <Grid item xs={12} display="flex" alignItems="center" justifyContent="center">
                                    {(newAction?.id == card.id && (
                                        ...
                                        <AddNewButton data-tut="reactour__add_task" onClick={() => setNewAction(card)}>
                                            Add task
                                        </AddNewButton>
                                    )}
                                </Grid>
